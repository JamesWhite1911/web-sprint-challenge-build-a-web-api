...
Node.js lets us use javascript to handle server stuff. Express helps us interface with HTTP requests and json.
2. Understand and explain the use of Middleware.
Middleware allows us to inject functionality into our code to avoid repetition or perform useful tasks.
3. The basic principles of the REST architectural style.
REST is a guideline for developing web services for use in modern web development.
  • uniform interface
  • client-server
  • stateless
  • cacheable
...
Express is a framework that makes it easier for us to build out endpoints
5. Describe tooling used to manually test the correctness of an API.
There are various tools which let you send HTTP requests to manually test functionality (Postman, HTTPie). You just need to send the server the right HTTP requests.